        ...
        for (const phoneNumber of numbers) {
            try {
                ...
                const metadata = JSON.stringify({
                    ...
                    campaign_type: campaignType || "bulk_outbound",
                    schedule_window: scheduleWindow || "Now",
                    user_prompt: prompt || "",
                ...
                results.push({ phoneNumber, status: 'failed', error: getErrorMessage(e, "Call dispatch failed") });
            }
        }
