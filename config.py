...
# Choose your voice provider: "minimax"
DEFAULT_TTS_PROVIDER = "minimax" 
MINIMAX_TTS_MODEL = "speech-01-turbo" # Or "speech-2.8-hd"
MINIMAX_TTS_VOICE = "male-qn-qingse"   # Default MiniMax voice


# --- 4. LARGE LANGUAGE MODEL (LLM) SETTINGS ---
# Choose "minimax"
DEFAULT_LLM_PROVIDER = "minimax"
DEFAULT_LLM_MODEL = "abab6.5g-chat"   # MiniMax default LLM
MINIMAX_LLM_TEMPERATURE = 0.7


# --- 5. TELEPHONY & CREDENTIALS ---
...
# Deepgram Authentication (STT)
DEEPGRAM_API_KEY = os.getenv("DEEPGRAM_API_KEY")

# Public server URL (e.g. ngrok HTTPS URL during local development)
